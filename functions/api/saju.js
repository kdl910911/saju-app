...
반드시 아래 JSON 형식으로만 응답하고, 마크다운이나 따옴표 밖 텍스트 없이 순수 JSON만 출력하세요.
...

{
  ...
  "cuts": [
    {
      "cut": 1,
      "imagePrompt": "Cute chibi anime character with warm glowing flame aura in comic panel",
      "sfx": "번쩍!",
    ...
    {
      "cut": 2,
      "imagePrompt": "Cute chibi anime character discovering special talent, sparkling triumphant",
      "sfx": "짜-안!",
    ...
    {
      "cut": 3,
      "imagePrompt": "Cute chibi anime character facing funny comic obstacle, shocked expression",
      "sfx": "쿵...!!",
    ...
    {
      "cut": 4,
      "imagePrompt": "Happy cheerful cute chibi anime ending scene with lucky charms",
      "sfx": "반짝✨",
...
`;
    ...
    // 최신 gemini-3.6-flash 및 3.5-flash만 호출
    ...
    if (!jsonMatch) {
      throw new Error("만화 데이터를 정상적으로 추출하지 못했습니다.");
    }
